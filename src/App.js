...
import Ship from '../../landing-page/src/images/ship.jpg';
import Plane from '../../landing-page/src/images/plane.jpg';
import Box from '../../landing-page/src/images/box.jpg';
import ModalAddUser from "./Layouts/LandingPage/ModalAddUser";
                  ...
                  <div className="col-12">
                    <nav className="site-navigation text-right ml-auto " role="navigation">
                      ...
                      <ul className="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                        ...
                        <a href="#" className="nav-link" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                          ...
                          <a className="dropdown-item" href="http://localhost:2000/login">As a Staff</a>
                        </div>
                      </ul>
                      </div>
                    </nav>
